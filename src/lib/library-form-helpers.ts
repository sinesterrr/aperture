...
export const buildLibraryOptions = (
  ...
  EnableChapterImageExtraction: data.ChapterImages.EnableChapterImageExtraction,
  ExtractChapterImagesDuringLibraryScan:
    data.ChapterImages.ExtractChapterImagesDuringLibraryScan,
  EnableTrickplayImageExtraction: data.Trickplay.EnableTrickplayImageExtraction,
