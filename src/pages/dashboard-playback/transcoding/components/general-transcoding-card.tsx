        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  ...
                  meet "Too many packets buffered for output stream" error in
                  FFmpeg logs. The recommended value is 2048.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          ...
          <div className="md:col-span-2">
            <p className="text-[0.8rem] text-muted-foreground">
              The 'Constant Rate Factor' (CRF) is the default quality setting
              for the x264 and x265 software encoders. You can set the values
              between 0 and 51, where lower values would result in better
