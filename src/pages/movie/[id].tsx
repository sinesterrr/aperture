    ...
    >
      ...
      <MediaDetail.Main>
        ...
        <MediaDetail.Content>
          ...
          <MediaDetail.Actions>
            <MediaActions movie={movie} onBeforePlay={MediaDetail.Backdrop.name === 'Backdrop' ? undefined : undefined} />
            ...
            <MediaDetail.Metadata>
              ...
              {movie.People && (
                <>
                  {movie.People.filter((p) => p.Type === "Director").length > 0 && (
                    <MediaDetail.MetadataItem label="Director">
                      <div className="flex flex-wrap gap-1">
                        {movie.People.filter((p) => p.Type === "Director").map((director, i, arr) => (
                  ...
                  {movie.People.filter((p) => p.Type === "Writer").length > 0 && (
                    <MediaDetail.MetadataItem label="Writers">
                      <div className="flex flex-wrap gap-1">
                        {movie.People.filter((p) => p.Type === "Writer").map((writer, i, arr) => (
