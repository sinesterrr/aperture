        ...
        <MediaDetail.Content>
          ...
          <MediaDetail.Actions>
            ...
            <MediaDetail.Metadata>
              ...
              {show.People && (
                <>
                  {show.People.filter((p) => p.Type === "Director").length > 0 && (
                    <MediaDetail.MetadataItem label="Director">
                      <div className="flex flex-wrap gap-1">
                        {show.People.filter((p) => p.Type === "Director").map((director, i, arr) => (
                  ...
                  {show.People.filter((p) => p.Type === "Writer").length > 0 && (
                    <MediaDetail.MetadataItem label="Writers">
                      <div className="flex flex-wrap gap-1">
                        {show.People.filter((p) => p.Type === "Writer").map((writer, i, arr) => (
